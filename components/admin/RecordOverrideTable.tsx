    ...
    <div className="cleariq-card p-6 cleariq-card-hover space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-3">
        <h4 className="text-xs font-extrabold text-slate-900 dark:text-slate-200 flex items-center gap-1.5 uppercase tracking-wider">
          <Filter className="w-3.5 h-3.5 text-emerald-600" /> {t('filters')}
        </h4>
        ...
        {activeTab === 'attendance' && (
          <table className="w-full text-left text-xs font-sans">
            <thead className="bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-slate-200 uppercase text-[10px] tracking-wider font-extrabold">
              <tr>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('checkInTime')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('checkOutTime')}</th>
              </tr>
            </thead>
        ...
        {activeTab === 'leaves' && (
          <table className="w-full text-left text-xs font-sans">
            <thead className="bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-slate-200 uppercase text-[10px] tracking-wider font-extrabold">
              <tr>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('type')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('permissionDetails')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('active')}</th>
                <th className="px-4 py-3.5 text-right dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('actions')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800 bg-white dark:bg-slate-900">
          ...
          <table className="w-full text-left text-xs font-sans">
            <thead className="bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-slate-200 uppercase text-[10px] tracking-wider font-extrabold">
              <tr>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('quantity')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('unit')}</th>
                <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('notes')}</th>
                <th className="px-4 py-3.5 text-right dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('actions')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800 bg-white dark:bg-slate-900">
