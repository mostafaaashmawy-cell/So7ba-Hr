          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 relative w-full md:w-80">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl pl-9 pr-4 py-2 text-xs font-semibold text-slate-950 dark:text-white focus:outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              ...
              {shifts.length > 0 && (
                <select
                  ...
                  className="bg-slate-50 border border-slate-200 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 text-slate-700 dark:text-slate-200 text-xs rounded-xl px-3 py-2 font-medium focus:outline-none focus:border-emerald-500 cursor-pointer"
                >
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.slice(0, 10).map((u) => (
                    <tr key={u.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none transition-colors">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {filteredAuditLogs.length === 0 ? (
                  ...
                  filteredAuditLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none transition-colors">
        ...
        <div className="cleariq-card p-6 cleariq-card-hover space-y-6">
          ...
          <div className="flex gap-2 max-w-md">
            <input
              ...
              className="flex-1 bg-slate-50 border border-slate-200 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 dark:text-white focus:outline-none focus:border-emerald-500"
            />
            <button
              type="button"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 dark:text-white focus:outline-none focus:border-emerald-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 dark:text-white focus:outline-none focus:border-emerald-500 cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 dark:text-white focus:outline-none focus:border-emerald-500 font-sans"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  {editForm.is_flexible && (
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-1.5 text-xs text-slate-950 dark:text-slate-100 dark:placeholder:text-slate-500 font-sans"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-950 dark:text-slate-100 dark:placeholder:text-slate-500 cursor-pointer"
                  >
