              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-800 dark:text-slate-200">
                  <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 uppercase text-[10px] tracking-wider">
                    <tr>
                      <th className="px-4 py-3 rounded-l-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('checkInTime')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('checkOutTime')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('totalWorked')}</th>
                      <th className="px-4 py-3 rounded-r-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('coordinates')}</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-sans">
                    {filteredAttendance.map((rec) => (
                      <tr key={rec.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-800 dark:text-slate-200">
                  <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 uppercase text-[10px] tracking-wider">
                    <tr>
                      <th className="px-4 py-3 rounded-l-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('type')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('permissionDetails')}</th>
                      <th className="px-4 py-3 rounded-r-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('active')}</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
                    {filteredLeaves.map((rec) => (
                      <tr key={rec.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none">
                        ...
                        <td className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">
                          <span
                ...
                <table className="w-full text-left text-xs text-slate-800 dark:text-slate-200">
                  <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 uppercase text-[10px] tracking-wider">
                    <tr>
                      <th className="px-4 py-3 rounded-l-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('fullName')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('quantity')}</th>
                      <th className="px-4 py-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('unit')}</th>
                      <th className="px-4 py-3 rounded-r-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('notes')}</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-sans">
