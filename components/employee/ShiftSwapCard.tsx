      ...
      <form onSubmit={handleSubmitSwap} className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 focus:outline-none focus:border-emerald-500 cursor-pointer dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500"
          >
            {colleagues.map((c) => (
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 focus:outline-none focus:border-emerald-500 font-sans dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-950 focus:outline-none focus:border-emerald-500 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:placeholder:text-slate-500"
          />
        </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-800">
                  ...
                  <th className="py-2.5 px-3 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الزميل' : 'Teammate'}</th>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {swapHistory.map((s) => (
                  <tr key={s.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none">
