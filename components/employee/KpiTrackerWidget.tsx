          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-700 dark:text-slate-300">
              <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 uppercase text-[10px] tracking-wider">
                <tr>
                  <th className="px-4 py-2.5 rounded-l-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('date')}</th>
                  <th className="px-4 py-2.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('quantity')}</th>
                  <th className="px-4 py-2.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('unit')}</th>
                  <th className="px-4 py-2.5 rounded-r-lg dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{t('notes')}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {entries.slice(0, 10).map((e) => (
                  <tr key={e.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 dark:border-slate-800/60 border-b last:border-none">
