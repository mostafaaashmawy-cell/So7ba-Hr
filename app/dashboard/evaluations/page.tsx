              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-950 dark:text-slate-100 focus:outline-none focus:border-blue-500 cursor-pointer"
                  >
                    {teamMembers.map((m) => (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2 text-xs font-bold text-slate-950 dark:text-slate-100 focus:outline-none focus:border-blue-500 font-sans"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-3.5 py-2.5 text-xs font-semibold text-slate-950 dark:text-slate-100 focus:outline-none focus:border-blue-500"
                  />
                </div>
              ...
              <div className="flex items-center gap-2">
                {isPrivileged && (
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl pl-8 pr-3 py-1.5 text-xs font-semibold text-slate-950 dark:text-slate-100 focus:outline-none w-36 sm:w-44"
                    />
                  </div>
                )}
                ...
                <div className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:placeholder:text-slate-500 rounded-xl px-2.5 py-1.5 text-xs font-bold text-slate-950 dark:text-slate-100 focus:outline-none font-sans"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-800">
              <table className="w-full text-left text-xs font-sans">
                <thead className="bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-slate-200 uppercase text-[10px] tracking-wider font-extrabold">
                  <tr>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الموظف' : 'Employee'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الشهر' : 'Month'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'المتوسط' : 'Avg Score'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الانضباط' : 'Punctuality'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الجودة' : 'Quality'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'المشاكل' : 'Solving'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'التواصل' : 'Comm'}</th>
                    <th className="px-4 py-3.5 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الملاحظات' : 'Notes'}</th>
                  </tr>
                </thead>
