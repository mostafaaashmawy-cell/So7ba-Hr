          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-700">
                <tr>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الموظف' : 'Employee'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الرقم القومي والاتصال' : 'National ID & Mobile'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الدور والدوام' : 'Role & Work Mode'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'قناة صرف الراتب' : 'Payout Channel'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'المستندات' : 'Vault Docs'}</th>
                  <th className="py-3.5 px-4 text-right dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الإجراءات' : 'Actions'}</th>
                </tr>
              </thead>
                          ...
                          <span
                            className={`px-2 py-0.5 rounded-full text-[10px] font-bold border ${
                              u.role === 'super_admin'
                                ...
                                : 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-800'
                            }`}
                          >
                            {u.role}
                          </span>
          ...
          <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
              >
