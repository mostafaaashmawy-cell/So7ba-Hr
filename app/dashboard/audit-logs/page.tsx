          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="lg:col-span-2 relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl pl-9 pr-3 py-2 text-xs font-bold text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              <select
                ...
                className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-slate-100 focus:outline-none cursor-pointer"
              >
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-1.5 text-xs font-bold text-slate-950 dark:text-white"
                />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-slate-500 mb-1">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-950 dark:text-slate-100 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-700">
                <tr>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'التوقيت (القاهرة)' : 'Timestamp'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'المسؤول القائم بالحركة' : 'Actor'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'نوع الإجراء' : 'Action Type'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'الكيان المتأثر' : 'Target Entity'}</th>
                  <th className="py-3.5 px-4 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'ملخص التغيير' : 'Details / Diff'}</th>
                  <th className="py-3.5 px-4 text-right dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-800">{isRtl ? 'التفاصيل' : 'Inspect'}</th>
                </tr>
              </thead>
          ...
          <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-xs font-bold text-slate-900 dark:text-slate-100 cursor-pointer focus:outline-none"
              >
